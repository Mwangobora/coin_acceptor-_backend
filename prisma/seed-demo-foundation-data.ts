...
export function device() {
  return {
    ...
    name: 'Demo Two-Slot ESP32 Charger',
    manufacturer: 'ESP32 Prototype',
    model: 'ESP32-2S-PROTOTYPE',
    firmware_version: 'prototype-1.0',
    ...
    metadata: { seed: 'demo', prototype: 'two-slot-offline' },
  };
}
...
export function port(index: number) {
  return {
    ...
    port_number: 1,
    port_type: 'usb_a',
    hardware_channel: index === 0 ? 'RELAY1_GPIO26' : 'RELAY2_GPIO25',
    status: 'available',
    power_state: 'off',
    maximum_voltage: 5,
